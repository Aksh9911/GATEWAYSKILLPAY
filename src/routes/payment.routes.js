...
router.post("/user/order", createRechargeRateLimiter(), validateUserStatus, createUserOrderHandler);       // For user app - auto-generates order params

// Direct SilkPay endpoints
router.post("/create", createOrderRateLimiter(), createPaymentHandler);             // POST /transaction/payin/v2
